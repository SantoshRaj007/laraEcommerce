                        ...
                        <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <ul class="list list-inline mb-0 brand-list">
                                    ...
                                    <li class="list-item">
                                        <span class="menu-link py-1">
                                            <input type="checkbox" name="brands" value="{{$brand->id}}" class="chk-brand" @if(in_array($brand->id,explode(',',$f_brands))) checked="checked"                        
                                            @endif>
                                            {{$brand->name}}
                                        </span>
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                data-slider-min="1" data-slider-max="3000" data-slider-step="5"
                            ...
                            <div class="price-range__info d-flex align-items-center mt-2">
                                ...
                                <div>
                                    ...
                                    <span class="price-range__max">$3000</span>
                                </div>
                            </div>
                        </div>
                    </div>
